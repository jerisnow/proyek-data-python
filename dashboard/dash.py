...
# Geolocation Dataset
geolocation = pd.read_csv('D:/Bangkit Academy 2024/Proyek Analisis Data/submission/data/geolocation_dataset.csv')
...
with st.sidebar:
    ...
    # Logo Image
    st.image("D:/Bangkit Academy 2024/Proyek Analisis Data/submission/logo-ecommerce.png")
...
st.caption('Copyright (C) Athirah Naura R.2024')